...
const Home: NextPage = () => {
  return (
    <div className="bg-slate-400 xl:place-content-center py-20 px-20 grid gap-10 lg:grid-cols-2 xl:grid-cols-3 space-y-5 min-h-screen">
      <div className="bg-white dark:bg-black flex flex-col justify-between p-6 rounded-3xl shadow-xl">
        ...
        <button className="mt-5 bg-blue-500 text-white p-3 text-center rounded-xl w-1/2 mx-auto block hover:bg-teal-500 hover:text-black active:bg-yellow-500 focus:bg-red-500">
          Checkout
        </button>
      </div>
      <div className="bg-white overflow-hidden rounded-2xl shadow-xl group">
        ...
        <div className="rounded-3xl p-6 bg-white relative -top-5">
          <div className="flex relative -top-16 items-end justify-between">
            ...
            <div className="h-24 w-24 bg-zinc-400 rounded-full group-hover:bg-red-300" />
            <div className="flex flex-col items-center">
        ...
        <div className="flex flex-col">
          ...
          <div className="mt-3 mb-5 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-5">
              <button className="rounded-lg bg-blue-200 flex justify-center aspect-square w-8 text-xl text-gray-500">
                -
              </button>
              <span>1</span>
              <button className="rounded-lg bg-blue-200 flex justify-center aspect-square w-8 text-xl text-gray-500">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="bg-blue-500 p-2 px-8 text-center text-sm text-white rounded-lg">
              Add to cart
            </button>
          </div>
        </div>
